...
var generateBombBoard = function generateBombBoard(numberOfRows, numberOfColumns, numberOfBombs) {
	...
	while (numberOfBombsPlaced < numberOfBombs) {
		...
		// This can overwrite already placed bombs right now.
	}
...
var getNumberOfNeighborBombs = function getNumberOfNeighborBombs(bombBoard, rowIndex, columnIndex) {
	...
	neighborOffsets.forEach(function (offset) {
		...
		if (neighborRowIndex < numberOfRows && neighborColumnIndex < numberOfColumns && neighborRowIndex >= 0 && neighborColumnIndex >= 0) {
